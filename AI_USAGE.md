...
| Testes unitários do backend | 211 testes (services, guards, filters, utils) | Um bug real foi encontrado e corrigido justamente por um teste escrito para o `PrismaExceptionFilter` (formato de resposta inconsistente no caso 500) |
