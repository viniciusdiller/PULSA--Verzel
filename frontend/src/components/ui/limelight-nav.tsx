...
type LimelightNavProps = {
  ...
  /** Índice ativo controlado externamente (ex. sincronizado com a rota
   * atual). Quando informado, tem prioridade sobre o clique interno —
   * necessário pra uma navegação real, onde o item ativo reflete a URL,
   * não só o último clique. */
  activeIndex?: number;
...
export const LimelightNav = ({
  ...
  return (
    <nav
      className={`relative inline-flex items-center h-16 overflow-hidden rounded-lg bg-card text-foreground border px-2 ${className ?? ""}`}
    >
